...
description: "Build reliable, fast E2E test suites with Playwright and Cypress. Invoke when implementing E2E test automation, debugging flaky tests, setting up CI/CD browser test pipelines, or testing critical user workflows (auth, checkout, signup)."
---
...
```
      ...
      /─────\
     /Integr\        ← MORE: Component interactions, API contract
    /────────\
